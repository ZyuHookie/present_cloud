...
import me.zhengjie.modules.system.domain.vo.ResetPassVo;
...
//    @PreAuthorize("@el.check('user:list')")
    ...
    // api/users/updatePass 参数是  UserPassVo （oldPass newPass）
    @ApiOperation("修改密码")
    ...
    //  pi/users/resetPass用于忘记密码的重置操作 参数是passVo(password,email)
    @ApiOperation("重置密码")
